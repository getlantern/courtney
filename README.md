[![Build Status](https://travis-ci.org/getlantern/courtney.svg?branch=master)](https://travis-ci.org/getlantern/courtney) [![Go Report Card](https://goreportcard.com/badge/github.com/getlantern/courtney)](https://goreportcard.com/report/github.com/getlantern/courtney) [![codecov](https://codecov.io/gh/getlantern/courtney/branch/master/graph/badge.svg)](https://codecov.io/gh/getlantern/courtney)
...
# Install
```
go get -u github.com/getlantern/courtney 
```
...
is a PR](https://github.com/getlantern/courtney/pull/5) for this project that lacks 
